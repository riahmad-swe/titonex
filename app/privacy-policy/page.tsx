		...
		<main className="mx-auto 2xl:px-96 lg:px-64 md:px-24 px-6 pt-16 md:pt-24 pb-24 bg-linear-to-br from-slate-900 via-blue-950 to-slate-900 text-gray-300">
			...
			<section className="mb-8">
				...
				<p className="leading-relaxed text-justify">
					Titonex (&#34;we&#34;, &#34;our&#34;, &#34;us&#34;) is a software
					development company operating multiple digital services including SaaS
					platforms, emergency transportation (Gari-X), healthcare and medical support
					services (Sustho), and water purification technology services. We are
					committed to protecting user privacy and handling personal data responsibly,
			...
			<section className="mb-8">
				...
				<ul className="list-disc pl-6 space-y-2">
					...
					<li>
						Location data (only when required for emergency or service delivery)
					</li>
					<li>
						Health-related information (only for Sustho services and only with user
						consent)
					</li>
					<li>Usage data, logs, and device information</li>
					<li>
						Payment-related information (processed via licensed third-party payment
						providers)
					</li>
				</ul>
			</section>
			...
			<section className="mb-8">
				...
				<ul className="list-disc pl-6 space-y-2">
					<li>Authorized service partners strictly for service delivery</li>
					<li>Government or regulatory authorities when legally required</li>
					<li>
						Licensed third-party service providers under strict confidentiality
						agreements
					</li>
				</ul>
			</section>
			...
			<section className="mb-8">
				...
				<p>
					...
					access control, encryption where applicable, and secure infrastructure, to
			...
			<section className="mb-8">
				...
				<p>
					...
					purposes or legal requirements. Data is securely deleted or anonymized when
					no longer required.
				</p>
			</section>
			...
			{/* 8. User Rights */}
			<section className="mb-8">
				<h2 className="text-xl font-semibold mb-3 text-white">8. User Rights</h2>
				<ul className="list-disc pl-6 space-y-2">
			...
			{/* 9. Cookies */}
			<section className="mb-8">
				<h2 className="text-xl font-semibold mb-3 text-white">9. Cookies & Tracking</h2>
				<p>
					Our platforms may use cookies or similar technologies to improve user
					experience and system performance. Users can control cookie preferences
					through their device or browser settings.
				</p>
			</section>
			...
			<section className="mb-8">
				...
				<p>
					Our services are not intentionally directed at children under 18 without
			...
			<section className="mb-8">
				...
				<p>
					This Privacy Policy is governed by the laws of Bangladesh, including but not
					limited to the Digital Personal Data Protection Act, 2023, ICT Act, and
			...
			{/* 13. Contact */}
			<section>
				<h2 className="text-xl font-semibold mb-3 text-white">13. Contact Us</h2>
				<p>
